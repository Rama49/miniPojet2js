    ...
    <div class="modal-content">
            ...
            <div class="container my-3">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select class="form-select form-select-lg mb-3 py-1" aria-label=".form-select-sm example" id="clubs">
                        ...
                        <input type="text" class="form-control py-2 mb-3" placeholder="Journée" id="MJ">
                        <input type="text" class="form-control py-2 mb-3"  placeholder="Match Gagné" id="G">
                        <input type="text" class="form-control py-2 mb-3"  placeholder="Match Null" id="N">
                    </div>
                    <div class="col-md-6">
                        <input type="text" class="form-control py-2 mb-3"  placeholder="Match Perdu" id="P">
                        <input type="text" class="form-control py-2 mb-3"  placeholder="Resultal Match" id="resultats">
                        <input type="text" class="form-control py-2 mb-3"  placeholder="Difference But" id="DB">
                        <input type="text" class="form-control py-2 mb-3"  placeholder="Points" id="Pts">
                    </div>
        ...
        <div class="modal-footer">
            <div class="d-grid gap-2 col-6 mx-auto">
                <button class="btn save rounded-pill" type="button" id='saves' onclick="save()">Enregistrer</button>
